...
<main class="main-side-content">
  <section class="main-content">
    ...
    <div class="search-box">
      <div class="searchBy-ttl">絞り込み条件</div><button
        class="disp-search"></button>
    </div>
    <font size="2">
      ...
      <form action="./dataretention2.php?id=0" method="post" name="terms_form">
        <ul class="searchBy-list none">
          <li>ガチャタイトル　:　<input class="searchBy-text" type="text" name="gatya">
          </li>
          <li>キャラクター名　:　<input class="searchBy-text" type="text" name="kyara">
          </li>
          <li>原　　　　　作　:　<input class="searchBy-text" type="text" name="gensaku">
          </li>
          <li>メ　ー　カ　ー　:　<input class="searchBy-text" type="text" name="me-ka-">
          </li>
          <li>出　品　日　時　:　<input class="searchBy-text mr-none" type="date"
              name="nitizi-start">～</li>
          <li>チケット種類　　:　<input class="searchBy-text" type="text" name="syurui">
          </li>
          <li>チケット枚数　　:　～<input class="searchBy-text ml-none" type="text"
              name="maisu-end">
            <input type="button" value="絞り込む" class="search"
              onclick="document.terms_form.submit();" />
          </li>
    ...
    <?php if($sort_id == 0){ ?>
    <input type="button" value="新しい順" class="sort-btn"
      style="background-color:#87CEFA"
      onclick="location.href='ex-list.php?sort_id=0&sarch_id=1'" />
    <input type="button" value="古い順" class="sort-btn"
      onclick="location.href='ex-list.php?sort_id=1&sarch_id=1'" />
    <label>　　</label>
    <input type="button" value="チケット数　昇順" class="sort-btn"
      onclick="location.href='ex-list.php?sort_id=2&sarch_id=1'" />
    <input type="button" value="チケット数　降順" class="sort-btn"
      onclick="location.href='ex-list.php?sort_id=3&sarch_id=1'" />
    ...
    <div class="item-list">
      ...
      <div class="responsive">
        <div class="img">
          <a target="_blank"
            href="./ex-confirm.php?id=<?php echo $data_part['EXHIBIT_ID'] ?>">
