...
<link rel="stylesheet"
  href="https://cdnjs.cloudflare.com/ajax/libs/Modaal/0.4.4/css/modaal.css" />
      ...
      <div class="modalreview">
        <div class="modalreview-box">
          ...
          <ul class="modalstars">
            ...
            <li class="modalstar" value="1">
              <p>☆</p>
            </li>
            <li class="modalstar" value="2">
              <p>☆</p>
            </li>
            <li class="modalstar" value="3">
              <p>☆</p>
            </li>
            <li class="modalstar" value="4">
              <p>☆</p>
            </li>
            <li class="modalstar" value="5">
              <p>☆</p>
            </li>
          </ul>
          <p>言葉遣い・言動</p>
        ...
        <div class="modalcomment">
          <p>コメント</p>
          <textarea class="modaltextarea" name="comment" id="comment" cols="30"
            rows="10"></textarea>
        </div>
        <div class="modalsubmit-block"><button class="submit">完了</button>
        </div>
      </div>
    </section>
