...
<header class="header">
      <div class="header-wrapper">
        <div class="header-innder">
          ...
          <form action="./data retention?no=1.php" method="post" class="header-form" name="a_form">
            ...
            <span class="header-search-icon">
              <a class="testResult" href="./data retention?no=1.php" onclick="document.a_form.submit();">
              </a>
            </span>
          </form>
