  ...
  <header class="header">
    <div class="header-wrapper">
      <div class="header-innder">
        ...
        <form action="./dataretention.php" method="post" class="header-form"
          name="a_form">
          ...
          <input type="text" placeholder="何かお探しですか？" class="index-text"
            name="text" />
          <span class="header-search-icon">
            <a class="testResult" href="./dataretention.php"
              onclick="document.a_form.submit();">
            </a>
          </span>
        </form>
          ...
          <li class="header-item">
            <div class="icon-wrapper">
              <a href="./profile.php"><i
                  class="fa-solid fa-circle-user fa-2x"></i></i></a>
            </div>
          </li>
          <?php } ?>
